...
5. IMPORTANT: You MUST generate EXACTLY the requested numberOfQuestions. Do not stop early. If the source material is exhausted, synthesize challenging questions based on implied concepts.
...
10. Avoid duplicate questions and ensure all content is high quality.
...
15. DO NOT TRUNCATE the JSON. Provide a complete, valid JSON object for the entire assessment.
`.trim();
